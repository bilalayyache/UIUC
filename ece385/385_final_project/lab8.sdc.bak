...
create_generated_clock -name {m_lab8_soc|sdram_pll|sd1|pll7|clk[0]} -source [get_pins {m_lab8_soc|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -multiply_by 1 -phase -54.000 -master_clock {main_clk_50} [get_pins {m_lab7_soc|sdram_pll|sd1|pll7|clk[0]}] 
create_generated_clock -name {m_lab8_soc|sdram_pll|sd1|pll7|clk[1]} -source [get_pins {m_lab8_soc|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -multiply_by 1 -phase -54.000 -master_clock {main_clk_50} [get_pins {m_lab7_soc|sdram_pll|sd1|pll7|clk[1]}] 
...
## OTG input
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[0]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[0]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[1]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[1]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[2]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[2]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[3]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[3]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[4]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[4]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[5]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[5]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[6]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[6]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[7]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[7]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[8]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[8]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[9]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[9]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[10]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[10]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[11]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[11]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[12]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[12]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[13]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[13]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[14]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[14]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[15]}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[15]}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[16]}]
...
# output of LED
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {LED[0]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {LED[1]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {LED[2]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {LED[3]}]
# output of HEX
...
# output of VGA
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[0]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[1]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[2]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[3]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[4]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[5]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[6]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_R[7]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[0]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[1]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[2]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[3]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[4]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[5]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[6]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_G[7]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[0]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[1]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[2]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[3]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[4]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[5]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[6]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_B[7]}]

set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_CLK}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_SYNC_N}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_BLANK_N}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_VS}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {VGA_HS}]

# output of OTG
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[0]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[1]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[2]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[3]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[4]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[5]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[6]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[7]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[8]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[9]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[10]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[11]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[12]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[13]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[14]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_DATA[15]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_ADDR[0]}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_ADDR[1]}]

set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_CS_N}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_RD_N}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_WR_N}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_RST_N}]
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  0.000 [get_ports {OTG_INT}]
