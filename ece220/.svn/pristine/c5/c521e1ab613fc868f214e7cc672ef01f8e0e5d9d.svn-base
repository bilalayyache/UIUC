...
int main ()
{
    ...
    int number; //Tracks guess number, game terminates after 6
    ...
    //Go until 6 guesses, or user wins
    for (number = 1; 6 >= number; number++) {
	printf ("Guess %d\n", number);
	do {
    ...
    puts ("You failed to guess correctly in 6 guesses.\n");
