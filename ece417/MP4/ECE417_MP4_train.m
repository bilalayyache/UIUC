...
%
% function [mapping] = ECE417_MP4_train ( avTrainingData, avValidateData, silenceModel, numN, resultFile )
%
...
avTrainingData = ECE417_MP4_clean_silence ( avTrainingData, silenceModel );
avValidateData = ECE417_MP4_clean_silence ( avValidateData, silenceModel );
